...
<html>
  <head>
    ...
    <title>Lucky Links Social . You are subscribed to the newsletter!</title>
    <meta property="og:title" content="Lucky Links Social . You are subscribed to the newsletter!" />
    <meta property="og:image" content="{page-images-1}" />
    <meta name="twitter:title" content="Lucky Links Social . You are subscribed to the newsletter!" />
    <meta name="twitter:description" content="Lucky Links Social . You are subscribed to the newsletter!" />
    <meta name="twitter:image:src" content="{page-images-1}" />
    
    <meta property="og:description" content="Lucky Links Social . You are subscribed to the newsletter!" />
    <meta name="description" content="Lucky Links Social . You are subscribed to the newsletter!" />
...
<style>
	* {
	...
	#mainWrapp-transactionrs--element{
		margin: 0px;
		padding: 0px;
	...
	.bodyClass1-transactionrs--element{
		background: #fffcfa;
		color: #ffffff;
	}
	.bodyClass2-transactionrs--element{
		background: #fff;
		color: #fff;
	}
	.bodyClass3-transactionrs--element{
		background: #fff;
		color: #111;
	}
	.wrapage-block-transactionrs--element{
		background-size: 100%;
		width: 100%;
	}
	.box_main-transactionrs--element{
		width: 100%;
		margin: 0 auto;
		text-align: center;
		display: flex;
	...
	.box_main-transactionrs--element h2{
		font-size: 24px;
		padding: 0px 0px 25px;
	}
	.box_main-transactionrs--element p{
		font-weight: 500;
		font-size: 18px;
	}
	p{
	...
	.mainBlock-transactionrs--element{
		text-align: start;
	}
	.mainBlock-transactionrs--element ul{
		text-align: start;
		padding: 20px;
		display: flex;
		flex-direction: column;
	...
	.mainBlock-transactionrs--element ul>li span{
		font-weight: bold;
	}
	.mainBlock-transactionrs--element{
		max-width: 948px;
	...
	.mainBlock-transactionrs--element .cBlock-transactionrs--element{
		text-align: start;
	}

	.bodyClass3-transactionrs--element .mainBlock-transactionrs--element{
		background: none;
		border-top: 2px dotted #f6f6f6;
		border-bottom: 2px dotted #f6f6f6;
	}
	.bodyClass2-transactionrs--element .mainBlock-transactionrs--element{
		background: #222222;
		color: #fff !important;
		box-shadow: 0px 0px 15px #222222;
	}
	.bodyClass2-transactionrs--element .mainBlock-transactionrs--element p{
		color: #fff !important;
	}
	.bodyClass1-transactionrs--element .mainBlock-transactionrs--element{
		background: #021324;
		color: #ffffff;
		border-left: 0px solid #1B1B2F;
	}
	.bodyClass1-transactionrs--element .mainBlock-transactionrs--element p{
		color: #ffffff !important;
	}
	.order-transactionrs--element{
...
<div class="bodyClass3-transactionrs--element" id="mainWrapp-transactionrs--element">


	<div class="wrapage-block-transactionrs--element">
		<div class="box_main-transactionrs--element">
			<div class="mainBlock-transactionrs--element">
...
<p class="cBlock-transactionrs--element">With our warmest regards!</p>
			</div>
		</div>
	</div>
